      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-full max-w-sm bg-[#F5F0EB] z-50 overflow-y-auto"
          >
            <div className="p-6">
              {/* Header */}
              <div className="flex items-center justify-between mb-12">
                <h2 className="font-serif text-2xl font-light tracking-[0.2em] text-[#1A1A1A]">
                  YUNIK
                </h2>
                <button
                  onClick={onClose}
